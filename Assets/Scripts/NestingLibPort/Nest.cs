...
namespace NestingLibPort
{
    ...
    public class Nest
    {
         ...
         * @return
         */
        public List<List<Placement>> startNest(Unfolder.TaskProgress taskProgress)
        {
            ...
            for (int i = 0; i < loopCount; i++)
            {
                ...
                Result result = launchWorkers(tree, binPolygon, config, taskProgress);
         ...
         * @return
         */
        public Result launchWorkers(List<NestPath> tree, NestPath binPolygon, Config config, Unfolder.TaskProgress taskProgress)
        {
            ...
            for (int i = 0; i < placelist.Count; i++)
            {
                ...
                if (!nfpCache.ContainsKey(key.GetKey()))
            ...
            totalOperations = nfpPairs.Count;
            ...
            for (int i = 0; i < generatedNfp.Count; i++)
            {
                ...
                String tkey = Nfp.getKey().GetKey(); //gson.toJson(Nfp.getKey());
